                ...
                <div class="row g-3">
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select" name="parentrace" required>
							...
							<option value="Cina" <c:if test = "${studentinfo.parent.parentrace == 'Cina'}"><c:out value="selected" /></c:if> >Cina</option>
							<option value="India" <c:if test = "${studentinfo.parent.parentrace == 'India'}"><c:out value="selected" /></c:if> >India</option>
						</select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select" name="parentreligion" required>
							...
							<option value="Buddha" <c:if test = "${studentinfo.parent.parentreligion == 'Buddha'}"><c:out value="selected" /></c:if> >Buddha</option>
							<option value="Hindu" <c:if test = "${studentinfo.parent.parentreligion == 'Hindu'}"><c:out value="selected" /></c:if> >Hindu</option>
							<option value="Kristian" <c:if test = "${studentinfo.parent.parentreligion == 'Kristian'}"><c:out value="selected" /></c:if> >Kristian</option>
						</select>
                        <div class="invalid-feedback">
