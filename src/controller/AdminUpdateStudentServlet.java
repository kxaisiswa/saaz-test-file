...
public class AdminUpdateStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Student updtaccountstudent = new Student();
		
		updtaccountstudent.setStudid(Integer.parseInt(request.getParameter("studid")));
		updtaccountstudent.setStudpassword(request.getParameter("studpassword"));
		
		String updtaccountstatus = studdao.updatestudentaccount(updtaccountstudent);
		...
		String updtstudentstatus = studdao.updatestudent(updtstudent);
		...
		String updtparentstatus = parentdao.addparent(newparent);
		
		Student updtparentstudent = new Student();

		updtparentstudent.setStudid(Integer.parseInt(request.getParameter("studid")));
		updtparentstudent.setParentic(Long.parseLong(request.getParameter("parentic")));
		
		String updtstudparentstatus = studdao.updatestudentparent(updtparentstudent);
		
		if(updtaccountstatus == "Account information updated" && updtstudentstatus == "Student information updated" && updtparentstatus == "success" && updtstudparentstatus == "success") {
			request.setAttribute("status", "Student information updated");
		}
		else {
			request.setAttribute("status", "Update student information failed");
		}

		request.setAttribute("studentinfo", studdao.viewstudent(Integer.parseInt(request.getParameter("studid"))));
		request.setAttribute("studentparentinfo", studdao.viewstudentparent(Integer.parseInt(request.getParameter("studid"))));
		request.setAttribute("studentaccountinfo", studdao.viewstudent(Integer.parseInt(request.getParameter("studid"))));
		RequestDispatcher view = request.getRequestDispatcher("Admin_update_student.jsp");
