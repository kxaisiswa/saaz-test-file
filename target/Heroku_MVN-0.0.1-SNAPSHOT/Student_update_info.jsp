            ...
            <form action="UpdateStudentServlet" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="row g-3">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control" name="studrace" placeholder="" value="<c:out value="${studentinfo.studrace}" />" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control" name="studreligion" placeholder="" value="<c:out value="${studentinfo.studreligion}" />" required>
                        <div class="invalid-feedback">
	                ...
	                <div class="row mt-4" id="collegeinput" style="display: none !important;">
	                	<div class="col-6">
	                        ...
	                        <input type="text" class="form-control" name="collegecode" placeholder="" value="<c:out value="${studentinfo.collegecode}" />">
	                        <div class="invalid-feedback">
	                    ...
	                    <div class="col-6">
	                        ...
	                        <input type="text" class="form-control" name="collegename" placeholder="" value="<c:out value="${studentinfo.collegename}" />">
	                        <div class="invalid-feedback">
