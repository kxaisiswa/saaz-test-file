...
<body class="bg-light">
    <div class="p-3 text-dark sidebar-style">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="AdminRedirectServlet?action=account" class="nav-link active">Account</a>
            </li>
            <li>
            ...
            <form action="UpdateAdminServlet" method="post" class="needs-validation" novalidate>
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="adminid" value="<c:out value="${admininfo.adminid}" />" required>
                    ...
                    <div class="col-6">
                        ...
                        <select class="form-select" name="superviseid" required>
							...
							<c:forEach items="${superviselist}" var="sl">
								<option <c:if test = "${sl.adminid == admininfo.superviseid}"><c:out value="selected" /></c:if> value="<c:out value="${sl.adminid}" />"><c:out value="${sl.adminname}" /></option>
							</c:forEach>
                        </select>
                        <div class="invalid-feedback">
                            Sila pilih ID penyelia.
                        </div>
                    </div>
                    <div class="col-6">
